              ...
              {regForm.plan === "escuela" && (
                <div>
                  ...
                  <div className="flex gap-2">
                    ...
                    >
                      {[
                        ["+54","🇦🇷 AR +54"],["+61","🇦🇺 AU +61"],["+43","🇦🇹 AT +43"],
                        ["+32","🇧🇪 BE +32"],["+591","🇧🇴 BO +591"],["+55","🇧🇷 BR +55"],
                        ["+1","🇨🇦 CA +1"],["+56","🇨🇱 CL +56"],["+57","🇨🇴 CO +57"],
                        ["+506","🇨🇷 CR +506"],["+53","🇨🇺 CU +53"],["+1-809","🇩🇴 DO +1-809"],
                        ["+593","🇪🇨 EC +593"],["+503","🇸🇻 SV +503"],["+34","🇪🇸 ES +34"],
                        ["+1-473","🇬🇩 GD +1-473"],["+502","🇬🇹 GT +502"],["+592","🇬🇾 GY +592"],
                        ["+504","🇭🇳 HN +504"],["+36","🇭🇺 HU +36"],["+62","🇮🇩 ID +62"],
                        ["+353","🇮🇪 IE +353"],["+91","🇮🇳 IN +91"],["+39","🇮🇹 IT +39"],
                        ["+1-876","🇯🇲 JM +1-876"],["+81","🇯🇵 JP +81"],["+52","🇲🇽 MX +52"],
                        ["+505","🇳🇮 NI +505"],["+31","🇳🇱 NL +31"],["+47","🇳🇴 NO +47"],
                        ["+64","🇳🇿 NZ +64"],["+507","🇵🇦 PA +507"],["+51","🇵🇪 PE +51"],
                        ["+63","🇵🇭 PH +63"],["+48","🇵🇱 PL +48"],["+351","🇵🇹 PT +351"],
                        ["+595","🇵🇾 PY +595"],["+1-787","🇵🇷 PR +1-787"],["+40","🇷🇴 RO +40"],
                        ["+7","🇷🇺 RU +7"],["+46","🇸🇪 SE +46"],["+65","🇸🇬 SG +65"],
                        ["+503","🇸🇻 SV +503"],["+1-868","🇹🇹 TT +1-868"],["+1","🇺🇸 US +1"],
                        ["+598","🇺🇾 UY +598"],["+58","🇻🇪 VE +58"],["+84","🇻🇳 VN +84"],
                        ["+44","🇬🇧 UK +44"],["+27","🇿🇦 ZA +27"],["+263","🇿🇼 ZW +263"],
                        ["+20","🇪🇬 EG +20"],["+234","🇳🇬 NG +234"],["+254","🇰🇪 KE +254"],
                        ["+233","🇬🇭 GH +233"],["+212","🇲🇦 MA +212"],["+216","🇹🇳 TN +216"],
                        ["+966","🇸🇦 SA +966"],["+971","🇦🇪 AE +971"],["+90","🇹🇷 TR +90"],
                        ["+82","🇰🇷 KR +82"],["+86","🇨🇳 CN +86"],["+886","🇹🇼 TW +886"],
                        ["+33","🇫🇷 FR +33"],["+49","🇩🇪 DE +49"],["+41","🇨🇭 CH +41"],
                      ].map(([val, label]) => (
