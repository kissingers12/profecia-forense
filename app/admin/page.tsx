...
export default function AdminPage() {
  ...
  const [codes, setCodes] = useState<{ id: string; code: string; file_name: string; file_name_2: string | null; used: boolean; created_at: string }[]>([]);
                    ...
                    <div key={c.id} className="flex items-center gap-3 px-4 py-3 rounded-xl bg-white/[0.03] hover:bg-white/5 transition-colors">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-[#8a7a6a] text-xs truncate">
                          {c.file_name_2 ? "eBook + PDF" : c.file_name}
                        </p>
                      </div>
